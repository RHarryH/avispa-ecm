...
CREATE TABLE IF NOT EXISTS folder_ancestors (
    ...
    ancestors_id VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS autolink_rules (
    autolink_id VARCHAR(255) NOT NULL,
    rules VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS context_ecm_configs (
    ...
    ecm_configs_id VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS dictionary_value_columns (
    dictionary_value_id VARCHAR(255) NOT NULL,
    columns VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS upsert (
    id VARCHAR(255) NOT NULL,
    property_page_id VARCHAR(255) NOT NULL,
    PRIMARY KEY (id),
