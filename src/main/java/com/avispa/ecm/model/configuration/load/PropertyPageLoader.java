 ...
 */
@Component
class PropertyPageLoader extends JsonContentGenericLoader<PropertyPage, PropertyPageDto, PropertyPageMapper> {
    ...
    protected PropertyPageLoader(EcmConfigRepository<PropertyPage> ecmConfigRepository,
        ...
        super(ecmConfigRepository, ecmConfigMapper, contentService, jsonValidator, "/json-schemas/property-page-content.json");
    }
}
